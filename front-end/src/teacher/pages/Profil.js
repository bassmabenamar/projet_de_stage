        ...
        <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
          ...
          >
            ...
            <p className="text-slate-500 font-medium">
              Gérez votre identité académique et la sécurité de votre compte.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="flex-1 z-10">
                <div className="flex flex-wrap justify-between items-start gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-3xl font-black text-[#002366] tracking-tight mb-1">
                      Dr. Elena Rodriguez
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                  ...
                  <div className="flex items-center gap-4 group cursor-pointer">
                    <motion.div 
                      ...
                      className="w-12 h-12 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center transition-colors group-hover:bg-blue-600 group-hover:text-white"
                    >
                      <Mail size={20} />
                    </motion.div>
                  ...
                  <div className="flex items-center gap-4 group cursor-pointer">
                    <motion.div 
                      whileHover={{ rotate: -15 }}
                      className="w-12 h-12 bg-orange-50 text-orange-600 rounded-2xl flex items-center justify-center transition-colors group-hover:bg-orange-600 group-hover:text-white"
                    >
                      <Phone size={20} />
                    </motion.div>
            ...
            >
              ...
              <div className="flex justify-between items-center mb-8">
                <h3 className="font-black text-[#002366] tracking-tight">
                  Matières
                </h3>
            ...
            >
              ...
              <div className="flex justify-between items-center mb-10">
                <h3 className="font-black text-[#002366] tracking-tight flex items-center gap-2">
                  Résumé de l'emploi du temps
                </h3>

                <div className="flex items-center gap-2 text-slate-400 font-bold text-xs uppercase tracking-widest">
                  <Calendar size={14} /> Aujourd’hui, 24 Oct
                </div>
              </div>
              ...
              <div className="space-y-8 relative before:absolute before:left-[111px] before:top-2 before:bottom-2 before:w-[2px] before:bg-slate-50">
                ...
                <ScheduleRow
                  time="09:00"
                  duration="60 min"
                  title="Salle 302 : Calcul AP"
                  desc="Présence obligatoire • 24 étudiants"
                  color="bg-blue-600"
                />
                ...
                <ScheduleRow
                  ...
                  desc="Salle de conférence principale • Planification"
                  color="bg-orange-500"
                />
                ...
                <ScheduleRow
                  ...
                  desc="Session virtuelle • Accompagnement individuel"
                  color="bg-slate-300"
                />
              </div>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-black text-[#002366] tracking-tight mb-8">
              ...
              <div className="flex items-center justify-between p-6 bg-blue-50/30 rounded-[24px] border border-blue-50 mb-8">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-[13px] font-black text-[#002366]">
                ...
                <div className="relative inline-flex items-center cursor-pointer group">
                  ...
                  <div className="w-11 h-6 bg-slate-200 rounded-full peer peer-checked:bg-[#002366] after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:after:translate-x-full"></div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 ml-4">
                ...
                <div>
                  ...
                  <p className="text-white/40 text-[10px] font-bold uppercase tracking-widest">
                    Connecté actuellement sur 2 appareils
                  </p>
                </div>
              </div>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        ...
        <h4 className="text-[14px] font-bold text-[#002366]">
          {title}
        </h4>
      </div>

      <span className="text-[10px] font-black text-slate-400 bg-white px-3 py-1 rounded-lg border border-slate-100 uppercase tracking-widest">
        {code}
      </span>
    </motion.div>
  );
...
const ScheduleRow = ({ time, duration, title, desc, color }) => (
  ...
  >
    ...
    <div className="flex items-start gap-6 flex-1">
      ...
      <div>
        <h4 className="text-[15px] font-black text-[#002366] group-hover:text-blue-600 transition-colors">
          {title}
        </h4>
