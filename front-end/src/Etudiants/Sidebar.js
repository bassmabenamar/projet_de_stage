...
import { Link, useLocation } from "react-router-dom"; // Khass t-installer react-router-dom
import {
          ...
          <Link
            ...
            className={`flex items-center gap-3 px-3 py-2.5 rounded-md text-sm font-medium w-full transition-all duration-300 border-l-4
              ${location.pathname !== item.path 
                ? "hover:translate-x-1 hover:shadow-md hover:text-[#2F5D9F] hover:bg-orange-50 hover:border-l-[#E55B2D] text-[#2F5D9F]" 
