...
class PaiementController extends Controller
{
    ...
    {
        // ✅ Null-safe: étudiant supprimé ou relation manquante
        $nomEtudiant = $paiement->etudiant
    ...
    {
        // ✅ Null-safe: l'étudiant peut être null si supprimé de la BDD
        $nomEtudiant = $p->etudiant
            ? $p->etudiant->prenom . ' ' . $p->etudiant->nom
            : 'Étudiant inconnu';

        $classeId = $p->etudiant?->classe_id ?? '';
