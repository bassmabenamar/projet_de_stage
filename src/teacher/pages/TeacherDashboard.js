...
import { 
  ...
  MoreVertical, Filter, CheckSquare
} from 'lucide-react';
      ...
      <main className="flex-1 flex flex-col relative overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
          ...
          >
            ...
            >
              <div>
                <h1 className="text-[28px] font-black text-[#002366] mb-1">
                  Bon retour, Sarah !
                </h1>

                <p className="text-slate-400 font-medium">
                  Vous avez 4 cours aujourd’hui et 12 devoirs à corriger.
                </p>
              </div>
            ...
            <div className="grid grid-cols-12 gap-8">
              ...
              >
                ...
                <div className="bg-white rounded-[32px] p-8 border border-slate-100 shadow-sm">
                  ...
                  <div className="space-y-4">
                    ...
                    <ScheduleItem 
                      time="09:00 AM"
                      title="Chimie avancée - Classe 11A"
                      location="Bloc Laboratoire 4 • Salle 12"
                      active
                    />

                    <ScheduleItem 
                      time="10:30 AM"
                      title="Bases organiques - Classe 10C"
                      location="Bâtiment principal • Salle 204"
                      comingSoon
                    />
                    ...
                    <ScheduleItem 
                      time="02:30 PM"
                      title="Sciences générales - Classe 9B"
                      location="Bâtiment principal • Salle 102"
                    />
                  ...
                  <table className="w-full">
                    ...
                    <thead>
                      <tr className="text-left text-[10px] font-black text-slate-300 uppercase tracking-widest border-b border-slate-50">
                        ...
                        <th className="pb-4">Type d’activité</th>
              ...
              >
                ...
                <div className="bg-white rounded-[32px] p-8 border border-slate-100 shadow-sm">
                  ...
                  <h2 className="text-lg font-black text-[#002366] mb-6">
                    Annonces
                  </h2>
                  ...
                  <div className="space-y-6">
                    ...
                    <AnnouncementItem 
                      ...
                      text="La journée sportive annuelle est prévue vendredi prochain."
                      time="Publié il y a 2 heures"
                    />

                    <AnnouncementItem 
                      category="SERVICE INFORMATIQUE"
                      text="Maintenance de la plateforme dimanche de 2h à 6h."
                      time="Publié hier"
                    />
                ...
                <div className="bg-white rounded-[32px] p-8 border border-slate-100 shadow-sm relative overflow-hidden">
                  ...
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <h2 className="text-lg font-black text-[#002366]">
                      Tâches en attente
                    </h2>

                    <span className="bg-[#002366] text-white w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-bold">
                      5
                    </span>
                  </div>
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <TaskItem label="Corriger les rapports de laboratoire" />

                    <TaskItem label="Préparer l’examen blanc 11A" />

                    <TaskItem label="Téléverser le plan du semestre" />
  ...
  >
    ...
    <div className="flex items-center gap-6">
      ...
      <div className="text-center">
        <p className="text-sm font-black text-[#002366] leading-none">
          {time.split(' ')[0]}
        </p>
    ...
    {comingSoon && (
      <span className="text-[8px] font-black bg-orange-50 text-orange-500 px-3 py-1 rounded-full uppercase tracking-widest">
        Bientôt
      </span>
    )}
    ...
    {active && (
      <div className="flex -space-x-2">
        ...
        <div className="w-6 h-6 rounded-full border-2 border-white bg-[#002366] flex items-center justify-center text-[8px] font-bold text-white">
          +24
        </div>
      </div>
    )}
...
const ActivityRow = ({ name, id, type, status, date, progress }) => {
  ...
  const statusStyles = {
    "À CORRIGER": "bg-orange-50 text-orange-500",
    "TERMINÉ": "bg-emerald-50 text-emerald-500",
    "EN COURS": "bg-blue-50 text-blue-500"
  };
  ...
  return (
    <tr className="border-b border-slate-50 group hover:bg-slate-50/50 transition-colors">
      ...
      <td className="py-5 text-[10px] text-slate-400 font-bold">
        {date}
      </td>
...
const AnnouncementItem = ({ category, text, time }) => (
  <div className="group cursor-pointer">
    ...
    <p className="text-xs font-bold text-[#002366] leading-relaxed mb-1 group-hover:text-blue-600 transition-colors">
      {text}
    </p>
...
const TaskItem = ({ label }) => (
  <div className="flex items-center gap-3 group cursor-pointer">
    ...
    <span className="text-xs font-bold text-slate-600 group-hover:text-[#002366] transition-colors">
      {label}
    </span>
