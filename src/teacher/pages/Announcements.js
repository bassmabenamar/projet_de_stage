        ...
        <div className="flex-1 overflow-y-auto p-10 custom-scrollbar">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="mb-12 flex justify-between items-end">
              <div>
                <h1 className="text-[36px] font-black text-[#002366] tracking-tight mb-2">
                  Annonces
                </h1>

                <p className="text-slate-400 font-medium text-lg">
                  Gérez et diffusez les informations importantes à vos classes.
                </p>
              </div>
              ...
              >
                <Layout size={16} /> Personnaliser la Vue
              </motion.div>
            </motion.div>
              ...
              <motion.div variants={itemVariants} className="col-span-12 lg:col-span-4">
                <div className="bg-white rounded-[45px] p-10 border border-slate-100 shadow-2xl shadow-blue-900/5 sticky top-5 overflow-hidden group">
                  ...
                  <div className="flex items-center gap-5 mb-10 relative">
                    ...
                    <h2 className="text-2xl font-black text-[#002366] tracking-tight">
                      Nouvelle Annonce
                    </h2>
                  </div>
                  ...
                  <div className="space-y-8 relative">
                    ...
                    <InputField 
                      ...
                      placeholder="Ex : Mise à jour des examens" 
                    />
                    
                    <div className="space-y-4">
                      <label className="text-[11px] font-black text-slate-300 uppercase tracking-[0.2em] block">
                        Classes Ciblées
                      </label>
                    ...
                    <div className="flex gap-4 pt-4">
                      ...
                      >
                        <Paperclip size={18} /> Ajouter un Fichier
                      </motion.button>
                      ...
                      <motion.button 
                        whileHover={{ 
                          y: -5, 
                          scale: 1.02,
                          boxShadow: "0 20px 40px -10px rgba(0,35,102,0.3)"
                        }}
                        whileTap={{ scale: 0.98 }}
                      ...
                      >
                        <Send size={18} /> Publier l'Annonce
                      </motion.button>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-span-12 lg:col-span-8 space-y-8">
                ...
                <div className="space-y-8">
                  ...
                  <AnnouncementCard 
                    icon={<Beaker size={28}/>}
                    tag="Physique 101-A"
                    room="Séance Laboratoire II"
                    time="Il y a 2 heures"
                    title="Consignes du laboratoire pour jeudi"
                    content="Tous les étudiants doivent apporter leurs lunettes de protection et leurs blouses pour la prochaine séance pratique."
                    views="142"
                    replies="12"
                    files="2"
                    color="emerald"
                  ...
                  <AnnouncementCard 
                    ...
                    tag="Physique 101-B"
                    room="Mercredi à 16h15"
                    time="Hier"
                    title="Séance de révision du contrôle"
                    content="Une séance de questions/réponses sera organisée vendredi dans l’auditorium C."
                    views="89"
                    replies="5"
                    color="blue"
                  />
                  ...
                  <AnnouncementCard 
                    ...
                    tag="Mécanique Quantique"
                    room="24 Octobre 2023"
                    time="Il y a 3 jours"
                    title="Publication des notes terminée"
                    content="Les notes du deuxième devoir ont été publiées sur la plateforme."
                    views="210"
                    replies="0"
                    color="purple"
                  />
            ...
            <div className="grid grid-cols-12 gap-10 mt-16 mb-12">
              <AnalyticsCircleCard rate="84" label="Taux d’Engagement" />
              <AnalyticsBarChart />
            </div>
          </motion.div>
        </div>
...
const ClassTag = ({ label }) => (
  <label className="flex items-center gap-3 cursor-pointer group p-4 bg-slate-50 rounded-[20px] hover:bg-blue-50 transition-colors">
    ...
    <span className="text-[12px] font-bold text-slate-500 group-hover:text-[#002366] transition-colors">
      {label}
    </span>
  </label>
);
...
const AnnouncementCard = ({
  ...
  return (
    <motion.div 
      ...
      className="bg-white rounded-[45px] p-10 border border-slate-50 shadow-sm hover:shadow-2xl hover:shadow-blue-900/10 transition-all"
    >
      <div className="flex gap-10">
        
        <div className={`w-20 h-20 rounded-[30px] flex items-center justify-center border shadow-xl ${themes[color]}`}>
          {icon}
        </div>
        ...
        <div className="flex-1">
          ...
          <h3 className="text-2xl font-black text-[#002366] mb-4">
            {title}
          </h3>

          <p className="text-[15px] text-slate-400 font-medium leading-relaxed mb-10 max-w-3xl">
            {content}
          </p>

          <div className="flex items-center gap-12 pt-8 border-t border-slate-50">
            <Stat icon={<Eye size={18}/>} value={views} label="Vues" />
            <Stat icon={<MessageCircle size={18}/>} value={replies} label="Réponses" />

            {files && (
              <Stat icon={<FileText size={18}/>} value={files} label="Fichiers" />
            )}
          </div>
...
const Stat = ({ icon, value, label }) => (
  <div className="flex items-center gap-2 text-[11px] font-black text-slate-400 uppercase tracking-widest">
    <span className="p-2 rounded-lg bg-slate-50">
      {icon}
    </span>
...
const AnalyticsCircleCard = ({ rate, label }) => (
  <motion.div 
    whileHover={{ y: -10 }}
    className="col-span-12 lg:col-span-4 bg-[#002366] rounded-[50px] p-10 text-white shadow-2xl"
  >
    <h3 className="text-[12px] font-black uppercase tracking-[0.3em] opacity-60 mb-8">
      {label}
    </h3>
...
const AnalyticsBarChart = () => (
  <div className="col-span-12 lg:col-span-8 bg-white rounded-[50px] p-10 border border-slate-100 shadow-xl">
    <h3 className="text-[12px] font-black text-slate-400 uppercase tracking-[0.3em] mb-12">
      Portée des Annonces
    </h3>
  </div>
);
...
const FilterButton = ({ icon }) => (
  <motion.button 
    ...
    whileTap={{ scale: 0.9 }}
    className="p-4 bg-white rounded-2xl border border-slate-100 text-slate-400 shadow-sm"
  >
    {icon}
  </motion.button>
);
